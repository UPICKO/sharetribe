...
f.hasListener = function (a, b) {
    ...
    return Fa(this.u, function (a) {
        for (var h = 0; h < a.length; ++h)if (!(c && a[h].type != d || e && a[h].ya != b))return !0;
        return !1
    })
};
function Hb(a, b, c, d) {
...
function Rb(a, b, c, d, e) {
    if (n(b))for (var g = 0; g < b.length; g++)Rb(a, b[g], c, d, e); else c = Mb(c), a && a[Cb] ? a.Na(b, c, d, e) : a && (a = Nb(a)) && (b = a.Ca(b, c, !!d, e)) && N(b)
}
function N(a) {
    if (!q(a) && a && !a.va) {
        var b = a.src;
...
f.dispatchEvent = function (a) {
    ...
    var e = !0, g;
    if (b)for (var h = b.length - 1; !a.na && 0 <= h; h--)g = a.currentTarget = b[h], e = Vb(g, d, !0, a) && e;
    a.na || (g = a.currentTarget = c, e = Vb(g, d, !0, a) && e, a.na || (e = Vb(g, d, !1, a) && e));
    if (b)for (h = 0; !a.na && h < b.length; h++)g = a.currentTarget = b[h], e = Vb(g, d, !1, a) && e;
    return e
};
f.g = function () {
    O.i.g.call(this);
...
f = ec.prototype;
f.mb = function (a) {
    if (C || A)if (17 == this.H && !a.ctrlKey || 18 == this.H && !a.altKey || D && 91 == this.H && !a.metaKey)this.da = this.H = -1;
...
f.Na = function (a, b, c, d, e) {
    if (n(b))for (var g = 0; g < b.length; g++)this.Na(a, b[g], c, d, e); else c = c || this.handleEvent, e = e || this.Ea || this, c = Mb(c), d = !!d, b = a && a[Cb] ? a.Ca(b, c, d, e) : a ? (a = Nb(a)) ? a.Ca(b, c, d, e) : null : null, b && (N(b), delete this.Ga[b.key]);
    return this
};
f.ua = function () {
...
f.Ub = function (a) {
    ...
    if (!this.Ta || this.fa || b && (!(xb ? 0 == a.U.button : "click" == a.type || a.U.button & Bb[0]) || C && D && a.ctrlKey))this.dispatchEvent("earlycancel"); else {
        if (0 == this.Hb)if (this.dispatchEvent(new uc("start", this, a.clientX, a.clientY)))this.fa = !0, this.Sb && a.preventDefault(); else return; else this.Sb && a.preventDefault();
...
f.jc = function (a) {
    if (this.Ta) {
        var b = (this.oa && tc(this) ? -1 : 1) * (a.clientX - this.clientX), c = a.clientY - this.clientY;
        ...
        if (!this.fa) {
            ...
            if (d * d + e * e > this.Hb)if (this.dispatchEvent(new uc("start", this, a.clientX, a.clientY)))this.fa = !0; else {
                this.qa || this.Ua(a);
                return
            }
        }
...
function ed(a) {
    if (navigator.geolocation) {
        ...
        }, a), void 0, {enableHighAccuracy: !0}))) : (a.ma.setVisible(!1), a.Z.setVisible(!1));
